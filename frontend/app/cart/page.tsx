                ...
                {cart && cart.items.length > 0 && (
                    <div className="mt-12 grid gap-12 lg:grid-cols-[1fr_360px]">
                                            ...
                                            <div className="mt-4 flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    <button
                                                        ...
                                                        className="flex h-9 w-9 items-center justify-center rounded-full border border-neutral-300 text-lg transition hover:bg-neutral-100 disabled:cursor-not-allowed disabled:opacity-40"
                                                    >
                                                        −
                                                    </button>
                        ...
                        <aside className="h-fit rounded-2xl bg-neutral-50 p-6">
                            ...
                            <Link
                                href="/checkout"
                                className="mt-6 block w-full rounded-full bg-black px-6 py-3.5 text-center text-sm font-medium text-white transition hover:bg-neutral-800"
                            >
                                Checkout
                            </Link>
                        </aside>
